...
class MainActivity : AppCompatActivity(),BcrInterface,InternetBcrInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        internetReceiver.initializeInterface(this)
        ...
        registerReceiver(internetReceiver,intent)
...
//        updateUI(currentUser)
    ...
    override fun OnInternetConnection(isConnected: Boolean) {
